      ...
      <MainContent>
        <ContentBlock>
          ...
          <Paragraph>
            ...
            disposition par {ORGANISATION_NAME} sur son site Internet
            reconnaissent en avoir pris connaissance et les accepter.
          </Paragraph>
          ...
          <Paragraph>
            Le contenu de ce site et notamment, mais non exclusivement, les
            textes, photographies, mise en page, charte graphique, marques,
            logos et autres signes distinctifs qui apparaissent dans ce site
          ...
          <Paragraph>
            ...
            ce soit est interdite sauf accord express du directeur de
            publication.
          </Paragraph>
          <Paragraph>
          ...
          <Paragraph>
            ...
            pourra à tout moment, sans préavis, apporter des améliorations ou
            des changements aux programmes ou aux services décrits sur ce site.
          </Paragraph>
          <Paragraph>
            {ORGANISATION_NAME} décline toute responsabilité en cas de
            difficulté d’accès à son site ou d’interruptions dans la connexion
            quelles qu’en soient les causes.
          </Paragraph>
          <Paragraph>
            De plus, {ORGANISATION_NAME} ne saurait être tenu responsable d’un
            dommage ou virus qui pourrait infecter votre ordinateur ou tout
            matériel informatique, suite à une utilisation ou accès au site ou
          ...
          <Paragraph>
            ...
            hypertextes, notamment dans les rubriques Crédits et Annuaire.
            N’étant pas les gestionnaires de ces sites, nous ne pouvons pas en
            contrôler le contenu. En conséquence, nous ne pourrons en aucun cas
            être tenus pour responsables du contenu des sites ainsi accessibles,
            ou des éventuelles collectes et transmissions de données
            personnelles, installation de cookies ou tout autre procédé tendant
          ...
          <UnorderedList>
            <ListItem>
              que les pages de {DOMAIN_NAME} ne soient pas imbriquées à
              l’intérieur des pages d’un autre site, notamment à l’intérieur de
              frames ou de cadres,
            </ListItem>
            <ListItem>
              de n’utiliser à l’intérieur de la balise &lt;a&gt; ainsi qu’à
              l’intérieur de la balise &lt;title&gt; que des mots en rapport
              direct avec le contenu de ce site et/ou de la page pointée en
              particulier.
            </ListItem>
          </UnorderedList>
          <Heading2>Données personnelles</Heading2>
          <Paragraph>
            Ce site Internet ne fait pas usage de cookie ni d’un quelconque
            outil de comptage/suivi de son trafic.
          </Paragraph>
          <Paragraph>
          ...
          <Paragraph>
            ...
            données personnelles ainsi collectées conformément à la loi en
            vigueur.
          </Paragraph>
