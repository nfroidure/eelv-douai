...
export const definition = {
  title: "Après Fukushima, quelle transtion énergétique ?",
  description:
    "Après la catastrophe nucléaire de Fukushima, quelle transition énergétique pour notre région ?",
  href: "bilan_fukushima_transition",
